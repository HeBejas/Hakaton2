...
<body>
    ...
    <div class="container">
        ...
        <div class="information_block" style="margin-top: 25px;">
            ...
            <div class="information_block wow animate__animated animate__fadeInLeft" data-wow-delay="0.4s" style="margin-top: 25px;"><span>Телефон:</span><br> +7 (901) 865-87-55</div>
            <div class="information_block wow animate__animated animate__fadeInLeft" data-wow-delay="0.5s" style="margin-top: 25px;"><span>Вконтакте:</span><br> https://vk.com/weekendvmywer</div>
