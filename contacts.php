...
<body>
    ...
    <div class="container">
        ...
        <h2 style="margin-top: 50px;">Контакты</h2>
        <!-- <div class="information_block" style="margin-top: 25px;">В деревне Мувыр можно наслаждаться природой, прогуляться по лесу до висячего моста, прокатиться на лодке, рыбачить, организовать барбекю, устроить пикник в беседке или под открытым небом и многое другое.</div> -->
        <div class="information_block" style="margin-top: 25px;">
            Если ты любишь активный, интересный отдых в живописных местах, при этом тебе нравится узнавать что-то новое и полезное для себя, если ты сторонник семейного отдыха, то тебе обязательно нужно приехать в Мувыр Игринского района.
            </div>
            ...
            <div class="information_block" style="margin-top: 25px;"><span>Лодочная станция</span> с 9.00 до 21.00 в будни и выходные</div>
